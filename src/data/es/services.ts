export const services = [
	{
		...
		text: 'Experimenta la playa de Famara y las vistas del atardecer desde nuestra ubicación privilegiada.',
		icon: '/beach-icon.png',
	},
	{
	...
	{
		title: 'WiFi Gratuito',
		text: 'Disfruta de acceso a WiFi de alta velocidad en toda la propiedad. Ideal para trabajo remoto.',
		icon: '/wifi-icon.png',
	},
	{
		title: 'Parking',
